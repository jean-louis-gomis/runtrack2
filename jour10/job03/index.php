...
/*Affichage des données résultats de chaque ligne dans une table html*/
	echo "<table class='tftable'> <tr><th>Prénom</th><th> Nom</th><th> Naissance</th><th> Email</th></tr>";
  
  while($row = mysqli_fetch_assoc($result)) {
    echo "<tr><td>" . $row["prenom"]. "</td><td>" . $row["nom"]. "</td><td>" . $row["naissance"]. "</td><td>" . $row["email"]. "</td></tr>";
  }
echo "</table>";
} else {
  echo "0 results";
